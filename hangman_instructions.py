import pygame
from game_variables import chalk_font_40, chalk_font_60_underlined
from scene_base import SceneBase
from hangman_game import HangmanGame
from hangman_surfaces import HangmanSurfaces
...
class HangmanInstructions(SceneBase):
    def __init__(self):
        ...
        self.instructions = []
        for sentence in instructions_list:
            sentence_surface = chalk_font_40.render(sentence.upper(), False, "white")
            self.instructions.append(sentence_surface)
